...
def _format_summary_card_svg(report: DashboardWindow, title: str) -> str:
...
def _format_cost_card_svg(report: DashboardWindow, title: str) -> str:
...
def _format_focus_card_svg(report: DashboardWindow, title: str) -> str:
...
def _format_heatmap_card_svg(report: DashboardWindow, title: str) -> str:
...
def _format_page_card_svg(report: DashboardWindow, title: str) -> str:
...
def _format_projects_card_svg(report: DashboardWindow, title: str) -> str:
    project_rows = report.projects[:4]
    if not project_rows:
