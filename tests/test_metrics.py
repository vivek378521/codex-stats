...
from codex_stats.display import format_report_html, format_report_svg, format_watch_dashboard
...
class MetricsTestCase(unittest.TestCase):
    ...
    def test_report_svg_output(self) -> None:
        ...
        self.assertIn("Standalone shareable report asset", svg)
        self.assertIn("Top Sessions", svg)
