...
class MetricsTestCase(unittest.TestCase):
    ...
    def test_dashboard_html_output(self) -> None:
        ...
        self.assertIn("<!DOCTYPE html>", html)
        self.assertIn("Usage dashboard in the browser.", html)
        ...
        self.assertEqual(set(week_assets), {"summary-card", "cost-card", "focus-card", "projects-card"})
    ...
    def test_report_svg_output(self) -> None:
        ...
        self.assertEqual(set(assets), {"summary-card", "cost-card", "focus-card", "projects-card"})
