...
from codex_stats.display import format_report_html, format_report_svg, format_report_svg_assets, format_watch_dashboard
...
class MetricsTestCase(unittest.TestCase):
    ...
    def test_report_svg_output(self) -> None:
        ...
        self.assertEqual(set(assets), {"summary-card", "daily-tokens", "daily-cost", "project-share", "top-sessions"})
        self.assertIn("Daily Token Trend", assets["daily-tokens"])
